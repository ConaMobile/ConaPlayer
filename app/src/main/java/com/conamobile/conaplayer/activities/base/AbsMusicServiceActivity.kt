...
import com.conamobile.conaplayer.db.toPlayCount
...
import com.conamobile.conaplayer.service.MusicService.Companion.FAVORITE_STATE_CHANGED
import com.conamobile.conaplayer.service.MusicService.Companion.MEDIA_STORE_CHANGED
import com.conamobile.conaplayer.service.MusicService.Companion.META_CHANGED
import com.conamobile.conaplayer.service.MusicService.Companion.PLAY_STATE_CHANGED
import com.conamobile.conaplayer.service.MusicService.Companion.QUEUE_CHANGED
import com.conamobile.conaplayer.service.MusicService.Companion.REPEAT_MODE_CHANGED
import com.conamobile.conaplayer.service.MusicService.Companion.SHUFFLE_MODE_CHANGED
...
abstract class AbsMusicServiceActivity : AbsBaseActivity(), IMusicServiceEventListener {
    ...
    override fun onHasPermissionsChanged(hasPermissions: Boolean) {
        ...
        intent.putExtra("from_permissions_changed",
            true) // just in case we need to know this at some point
