package com.conamobile.conaplayer.service
...
import com.conamobile.conaplayer.activities.LockScreenActivity
import com.conamobile.conaplayer.appwidgets.*
import com.conamobile.conaplayer.auto.AutoMediaIDHelper
import com.conamobile.conaplayer.auto.AutoMusicProvider
import com.conamobile.conaplayer.extensions.showToast
import com.conamobile.conaplayer.extensions.toMediaSessionQueue
import com.conamobile.conaplayer.extensions.uri
import com.conamobile.conaplayer.glide.BlurTransformation
import com.conamobile.conaplayer.glide.GlideApp
import com.conamobile.conaplayer.glide.RetroGlideExtension.getDefaultTransition
import com.conamobile.conaplayer.glide.RetroGlideExtension.getSongModel
import com.conamobile.conaplayer.helper.ShuffleHelper.makeShuffleList
import com.conamobile.conaplayer.model.Song
import com.conamobile.conaplayer.model.Song.Companion.emptySong
import com.conamobile.conaplayer.model.smartplaylist.AbsSmartPlaylist
import com.conamobile.conaplayer.providers.HistoryStore
import com.conamobile.conaplayer.providers.MusicPlaybackQueueStore
import com.conamobile.conaplayer.providers.SongPlayCountStore
import com.conamobile.conaplayer.service.notification.PlayingNotification
import com.conamobile.conaplayer.service.notification.PlayingNotificationClassic
import com.conamobile.conaplayer.service.notification.PlayingNotificationImpl24
import com.conamobile.conaplayer.service.playback.Playback
import com.conamobile.conaplayer.service.playback.Playback.PlaybackCallbacks
import com.conamobile.conaplayer.util.MusicUtil
import com.conamobile.conaplayer.util.MusicUtil.toggleFavorite
import com.conamobile.conaplayer.util.PackageValidator
import com.conamobile.conaplayer.util.PreferenceUtil.crossFadeDuration
import com.conamobile.conaplayer.util.PreferenceUtil.isAlbumArtOnLockScreen
import com.conamobile.conaplayer.util.PreferenceUtil.isBluetoothSpeaker
import com.conamobile.conaplayer.util.PreferenceUtil.isBlurredAlbumArt
import com.conamobile.conaplayer.util.PreferenceUtil.isClassicNotification
import com.conamobile.conaplayer.util.PreferenceUtil.isHeadsetPlugged
import com.conamobile.conaplayer.util.PreferenceUtil.isLockScreen
import com.conamobile.conaplayer.util.PreferenceUtil.isPauseOnZeroVolume
import com.conamobile.conaplayer.util.PreferenceUtil.playbackPitch
import com.conamobile.conaplayer.util.PreferenceUtil.playbackSpeed
import com.conamobile.conaplayer.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import com.conamobile.conaplayer.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    companion object {
        ...
        const val RETRO_MUSIC_PACKAGE_NAME = "com.conamobile.conaplayer"
