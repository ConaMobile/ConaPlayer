...
import com.conamobile.conaplayer.adapter.playlist.PlaylistAdapter
...
import com.conamobile.conaplayer.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_A_Z
import com.conamobile.conaplayer.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_SONG_COUNT
import com.conamobile.conaplayer.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_SONG_COUNT_DESC
import com.conamobile.conaplayer.helper.SortOrder.PlaylistSortOrder.Companion.PLAYLIST_Z_A
import com.conamobile.conaplayer.interfaces.IPlaylistClickListener
...
class PlaylistsFragment :
    ...
    private fun handleSortOrderMenuItem(item: MenuItem): Boolean {
        val sortOrder: String = when (item.itemId) {
            R.id.action_song_sort_order_asc -> PLAYLIST_A_Z
            R.id.action_song_sort_order_desc -> PLAYLIST_Z_A
            R.id.action_playlist_sort_order -> PLAYLIST_SONG_COUNT
            R.id.action_playlist_sort_order_desc -> PLAYLIST_SONG_COUNT_DESC
